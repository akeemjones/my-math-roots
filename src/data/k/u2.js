...
_mergeKUnitData(1, {
  lessons: [
    ...
    // ── L2: Compare Sets (ku2l2) ──────────────────────────────────────────────
    {
      ...
      qBank: [
        // Easy — more, big gap
        {t:'Which shows more: 2 🌷 or 6 🌻?',       v:{type:'twoGroups',config:{leftCount:2,leftObj:'🌷',rightCount:6,rightObj:'🌻',op:'compare'}}, o:[{val:'2',tag:'err_less'},{val:'6'},{val:'4',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'8',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'6 is more than 2!', d:'e', s:null, h:'Count each group — which is bigger?'},
        {t:'Which shows more: 1 🐶 or 5 🐱?',       v:{type:'twoGroups',config:{leftCount:1,leftObj:'🐶',rightCount:5,rightObj:'🐱',op:'compare'}}, o:[{val:'1',tag:'err_less'},{val:'3',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'5'},{val:'6',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'5 is more than 1!', d:'e', s:null, h:'Which group has more?'},
        {t:'Which shows more: 3 🥕 or 7 🧩?',       v:{type:'twoGroups',config:{leftCount:3,leftObj:'🥕',rightCount:7,rightObj:'🧩',op:'compare'}}, o:[{val:'3',tag:'err_less'},{val:'5',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'7'},{val:'9',tag:'err_over_count',patternTag:'pattern_too_high'}], a:2, e:'7 is more than 3!', d:'e', s:null, h:'Count: which is bigger?'},
        // Easy — fewer, big gap
        {t:'Which shows fewer: 2 🐰 or 8 🐯?',      v:{type:'twoGroups',config:{leftCount:2,leftObj:'🐰',rightCount:8,rightObj:'🐯',op:'compare'}}, o:[{val:'1',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'2'},{val:'8',tag:'err_more'},{val:'4',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'2 is fewer than 8!', d:'e', s:null, h:'Fewer means the smaller number'},
        {t:'Which shows fewer: 4 🦊 or 1 🐴?',      v:{type:'twoGroups',config:{leftCount:4,leftObj:'🦊',rightCount:1,rightObj:'🐴',op:'compare'}}, o:[{val:'4',tag:'err_more'},{val:'1'},{val:'3',tag:'err_over_count',patternTag:'pattern_too_high'},{val:'5',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'1 is fewer than 4!', d:'e', s:null, h:'Which group is smaller?'},
        // Medium — smaller differences
        {t:'Which shows more: 4 🌷 or 6 🌻?',       v:{type:'twoGroups',config:{leftCount:4,leftObj:'🌷',rightCount:6,rightObj:'🌻',op:'compare'}}, o:[{val:'4',tag:'err_less'},{val:'5',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'6'},{val:'7',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'6 is more than 4!', d:'m', s:null, h:'Count carefully — these are close!'},
        {t:'Which shows fewer: 5 🐷 or 3 🧸?',      v:{type:'twoGroups',config:{leftCount:5,leftObj:'🐷',rightCount:3,rightObj:'🧸',op:'compare'}}, o:[{val:'2',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'3'},{val:'5',tag:'err_more'},{val:'6',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'3 is fewer than 5!', d:'m', s:null, h:'Fewer means smaller count'},
        {t:'Which shows more: 7 🦆 or 5 🍊?',       v:{type:'twoGroups',config:{leftCount:7,leftObj:'🦆',rightCount:5,rightObj:'🍊',op:'compare'}}, o:[{val:'5',tag:'err_less'},{val:'6',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'7'},{val:'8',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'7 is more than 5!', d:'m', s:null, h:'Which number is bigger?'},
        // Medium — same/equal
        ...
        {t:'Which shows fewer: 6 🥕 or 9 🧩?',      v:{type:'twoGroups',config:{leftCount:6,leftObj:'🥕',rightCount:9,rightObj:'🧩',op:'compare'}}, o:[{val:'5',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'6'},{val:'9',tag:'err_more'},{val:'7',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:1, e:'6 is fewer than 9!', d:'m', s:null, h:'Count carefully — which is smaller?'},
        ...
        {t:'Which shows more: 2 🦁 or 8 🐊?',       v:{type:'twoGroups',config:{leftCount:2,leftObj:'🦁',rightCount:8,rightObj:'🐊',op:'compare'}}, o:[{val:'2',tag:'err_less'},{val:'5',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'8'},{val:'9',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'8 is more than 2!', d:'e', s:null, h:'Count each group — which is bigger?'},
        {t:'Which shows fewer: 1 🦓 or 6 🦒?',      v:{type:'twoGroups',config:{leftCount:1,leftObj:'🦓',rightCount:6,rightObj:'🦒',op:'compare'}}, o:[{val:'1'},{val:'3',tag:'err_over_count',patternTag:'pattern_too_high'},{val:'6',tag:'err_more'},{val:'7',tag:'err_over_count',patternTag:'pattern_too_high'}], a:0, e:'1 is fewer than 6!', d:'e', s:null, h:'Fewer means the smaller group'},
        {t:'Which shows more: 1 🐊 or 7 🦕?',       v:{type:'twoGroups',config:{leftCount:1,leftObj:'🐊',rightCount:7,rightObj:'🦕',op:'compare'}}, o:[{val:'1',tag:'err_less'},{val:'4',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'7'},{val:'8',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'7 is more than 1!', d:'e', s:null, h:'Count each — which group is bigger?'},
        {t:'Which shows fewer: 3 🦏 or 9 🦛?',      v:{type:'twoGroups',config:{leftCount:3,leftObj:'🦏',rightCount:9,rightObj:'🦛',op:'compare'}}, o:[{val:'2',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'3'},{val:'9',tag:'err_more'},{val:'10',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'3 is fewer than 9!', d:'e', s:null, h:'Which group has fewer?'},
        // NEW — Medium: smaller-gap comparisons 4–7 range
        {t:'Which shows more: 4 🦋 or 6 🐸?',       v:{type:'twoGroups',config:{leftCount:4,leftObj:'🦋',rightCount:6,rightObj:'🐸',op:'compare'}}, o:[{val:'4',tag:'err_less'},{val:'5',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'6'},{val:'7',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'6 is more than 4!', d:'m', s:null, h:'Count carefully — which group is bigger?'},
        {t:'Which shows fewer: 4 🌸 or 7 🎈?',      v:{type:'twoGroups',config:{leftCount:4,leftObj:'🌸',rightCount:7,rightObj:'🎈',op:'compare'}}, o:[{val:'3',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'4'},{val:'7',tag:'err_more'},{val:'8',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'4 is fewer than 7!', d:'m', s:null, h:'Which group has fewer?'},
        {t:'Which shows more: 5 🦁 or 7 🐊?',       v:{type:'twoGroups',config:{leftCount:5,leftObj:'🦁',rightCount:7,rightObj:'🐊',op:'compare'}}, o:[{val:'5',tag:'err_less'},{val:'6',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'7'},{val:'8',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'7 is more than 5!', d:'m', s:null, h:'Count carefully — which is bigger?'},
    ...
    // ── L4: Compose & Decompose (ku2l4) ──────────────────────────────────────
    {
      ...
      qBank: [
        ...
        {t:'If 3 + 4 = 7, then 4 + 3 = ___?',       v:{type:'twoGroups',config:{leftCount:4,leftObj:'🦄',rightCount:3,rightObj:'🌈',op:'add'}}, o:[{val:'6',tag:'err_off_by_one'},{val:'7'},{val:'8',tag:'err_off_by_one'},{val:'1',tag:'err_under_count',patternTag:'pattern_too_low'}], a:1, e:'4 + 3 = 7 too! Switching the parts does not change the total!', d:'h', s:null, h:'The order does not matter — the total stays the same'},
  ...
  testBank: [
    ...
    {lessonId:'ku2l2', t:'Which shows more: 1 🐰 or 7 🐯?',       v:{type:'twoGroups',config:{leftCount:1,leftObj:'🐰',rightCount:7,rightObj:'🐯',op:'compare'}}, o:[{val:'1',tag:'err_less'},{val:'4',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'7'},{val:'9',tag:'err_over_count',patternTag:'pattern_too_high'}], a:2, e:'7 is more than 1!', d:'e', s:null, h:'Count each — which is bigger?'},
    {lessonId:'ku2l2', t:'Which shows fewer: 2 🦆 or 9 🍋?',      v:{type:'twoGroups',config:{leftCount:2,leftObj:'🦆',rightCount:9,rightObj:'🍋',op:'compare'}}, o:[{val:'2'},{val:'4',tag:'err_over_count',patternTag:'pattern_too_high'},{val:'9',tag:'err_more'},{val:'11',tag:'err_over_count',patternTag:'pattern_too_high'}], a:0, e:'2 is fewer than 9!', d:'e', s:null, h:'Fewer means the smaller number'},
    {lessonId:'ku2l2', t:'Which shows more: 5 🐷 or 8 🧸?',       v:{type:'twoGroups',config:{leftCount:5,leftObj:'🐷',rightCount:8,rightObj:'🧸',op:'compare'}}, o:[{val:'4',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'5',tag:'err_less'},{val:'7',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'8'}], a:3, e:'8 is more than 5!', d:'m', s:null, h:'Count carefully — which is bigger?'},
    ...
    {lessonId:'ku2l2', t:'Which shows more: 1 🦓 or 8 🦒?',        v:{type:'twoGroups',config:{leftCount:1,leftObj:'🦓',rightCount:8,rightObj:'🦒',op:'compare'}}, o:[{val:'1',tag:'err_less'},{val:'4',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'8'},{val:'9',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'8 is more than 1!', d:'e', s:null, h:'Count each — which group is bigger?'},
    ...
    {lessonId:'ku2l2', t:'Which shows fewer: 2 🦏 or 9 🦛?',        v:{type:'twoGroups',config:{leftCount:2,leftObj:'🦏',rightCount:9,rightObj:'🦛',op:'compare'}}, o:[{val:'1',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'2'},{val:'9',tag:'err_more'},{val:'10',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'2 is fewer than 9!', d:'e', s:null, h:'Fewer means the smaller group'},
    ...
    {lessonId:'ku2l2', t:'Which shows more: 5 🦄 or 7 🌈?',          v:{type:'twoGroups',config:{leftCount:5,leftObj:'🦄',rightCount:7,rightObj:'🌈',op:'compare'}}, o:[{val:'4',tag:'err_under_count',patternTag:'pattern_too_low'},{val:'5',tag:'err_less'},{val:'7'},{val:'8',tag:'err_off_by_one',patternTag:'pattern_one_more'}], a:2, e:'7 is more than 5!', d:'m', s:null, h:'Count carefully — which is bigger?'},
    {lessonId:'ku2l2', t:'Which shows fewer: 4 🦋 or 6 🌸?',         v:{type:'twoGroups',config:{leftCount:4,leftObj:'🦋',rightCount:6,rightObj:'🌸',op:'compare'}}, o:[{val:'3',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'4'},{val:'6',tag:'err_more'},{val:'7',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'4 is fewer than 6!', d:'m', s:null, h:'Which group has fewer?'},
    ...
    {lessonId:'ku2l2', t:'Which shows fewer: 3 🌸 or 7 🎈?',          v:{type:'twoGroups',config:{leftCount:3,leftObj:'🌸',rightCount:7,rightObj:'🎈',op:'compare'}}, o:[{val:'2',tag:'err_off_by_one',patternTag:'pattern_one_less'},{val:'3'},{val:'7',tag:'err_more'},{val:'8',tag:'err_over_count',patternTag:'pattern_too_high'}], a:1, e:'3 is fewer than 7!', d:'m', s:null, h:'Which group has fewer?'},
