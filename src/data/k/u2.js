...
_mergeKUnitData(1, {
  ...
  testBank: [
    ...
    {t:'Do 4 🍒 and 4 🌷 show the same amount?', v:{type:'twoGroups',config:{leftCount:4,leftObj:'🍒',rightCount:4,rightObj:'🌷',op:'compare'}}, o:[{val:'yes — same'},{val:'no — not the same',tag:'err_not_equal'}], a:0, e:'Both groups have 4 — they\'re the same!', d:'m', s:null, h:'Count each — do they match?'},
    // L3 — Compare Numbers (unique number pairs vs qBank)
    {t:'Which is greater: 1 or 9?',  v:{type:'twoGroups',config:{leftCount:1,leftObj:'🔵',rightCount:9,rightObj:'🔵',op:'compare'}}, o:[{val:'1',tag:'err_less'},{val:'9'}], a:1, e:'9 is greater than 1!', d:'e', s:null, h:'Which number is bigger?'},
    {t:'Which is less: 8 or 3?',     v:{type:'twoGroups',config:{leftCount:8,leftObj:'🔵',rightCount:3,rightObj:'🔵',op:'compare'}}, o:[{val:'8',tag:'err_more'},{val:'3'}], a:1, e:'3 is less than 8!', d:'e', s:null, h:'Which number is smaller?'},
    {t:'Which is greater: 3 or 7?',  v:{type:'twoGroups',config:{leftCount:3,leftObj:'🔵',rightCount:7,rightObj:'🔵',op:'compare'}}, o:[{val:'3',tag:'err_less'},{val:'7'}], a:1, e:'7 is greater than 3!', d:'m', s:null, h:'3 or 7 — which is bigger?'},
    {t:'Is 5 equal to 5?',           v:{type:'twoGroups',config:{leftCount:5,leftObj:'🔵',rightCount:5,rightObj:'🔵',op:'compare'}}, o:[{val:'yes — equal'},{val:'no — not equal',tag:'err_not_equal'}], a:0, e:'5 = 5 — they are equal!', d:'m', s:null, h:'Are both numbers the same?'},
    ...
    {t:'Which is greater: 4 or 9?',              v:{type:'twoGroups',config:{leftCount:4,leftObj:'🔵',rightCount:9,rightObj:'🔵',op:'compare'}}, o:[{val:'4',tag:'err_less'},{val:'9'}], a:1, e:'9 is greater than 4!', d:'e', s:null, h:'Which number is bigger?'},
    {t:'1 🎃 and 2 🌈 — how many in all?',        v:{type:'twoGroups',config:{leftCount:1,leftObj:'🎃',rightCount:2,rightObj:'🌈',op:'add'}}, o:[{val:'1',tag:'err_off_by_one'},{val:'2',tag:'err_off_by_one'},{val:'3'},{val:'4',tag:'err_off_by_one'}], a:2, e:'1 + 2 = 3 in all!', d:'e', s:null, h:'Count both groups together'},
    {t:'One less than 3 🐙 is how many?',         v:{type:'objectSet',config:{count:3,emoji:'🐙',layout:'line'}}, o:[{val:'1',tag:'err_off_by_one'},{val:'2'},{val:'3',tag:'err_same'},{val:'4',tag:'err_off_by_one'}], a:1, e:'3 take away 1 = 2!', d:'e', s:null, h:'Count back from 3'},
    ...
    {t:'Which is less: 1 or 8?',                  v:{type:'twoGroups',config:{leftCount:1,leftObj:'🔵',rightCount:8,rightObj:'🔵',op:'compare'}}, o:[{val:'1'},{val:'8',tag:'err_more'}], a:0, e:'1 is less than 8!', d:'e', s:null, h:'1 comes before 8 when counting'},
    {t:'2 🌸 and 2 🎈 — how many in all?',        v:{type:'twoGroups',config:{leftCount:2,leftObj:'🌸',rightCount:2,rightObj:'🎈',op:'add'}}, o:[{val:'2',tag:'err_off_by_one'},{val:'3',tag:'err_off_by_one'},{val:'4'},{val:'5',tag:'err_off_by_one'}], a:2, e:'2 + 2 = 4 in all!', d:'e', s:null, h:'Count: 1, 2 … then 3, 4'},
    ...
    {t:'Do 5 🦁 and 5 🐊 show the same amount?',   v:{type:'twoGroups',config:{leftCount:5,leftObj:'🦁',rightCount:5,rightObj:'🐊',op:'compare'}}, o:[{val:'yes — same'},{val:'no — not the same',tag:'err_not_equal'}], a:0, e:'Both groups have 5 — same!', d:'m', s:null, h:'Count each: 5 and 5 — do they match?'},
    {t:'Which is greater: 3 or 8?',                v:{type:'twoGroups',config:{leftCount:3,leftObj:'🔵',rightCount:8,rightObj:'🔵',op:'compare'}}, o:[{val:'3',tag:'err_less'},{val:'8'}], a:1, e:'8 is greater than 3!', d:'m', s:null, h:'3 or 8 — which comes later?'},
    {t:'Which is less: 4 or 7?',                   v:{type:'twoGroups',config:{leftCount:4,leftObj:'🔵',rightCount:7,rightObj:'🔵',op:'compare'}}, o:[{val:'4'},{val:'7',tag:'err_more'}], a:0, e:'4 is less than 7!', d:'m', s:null, h:'Which number comes first?'},
    {t:'Is 6 equal to 6?',                         v:{type:'twoGroups',config:{leftCount:6,leftObj:'🔵',rightCount:6,rightObj:'🔵',op:'compare'}}, o:[{val:'yes — equal'},{val:'no — not equal',tag:'err_not_equal'}], a:0, e:'6 = 6 — they are equal!', d:'m', s:null, h:'Both say 6 — are they the same?'},
    {t:'3 🦓 and 3 🦒 — how many in all?',          v:{type:'twoGroups',config:{leftCount:3,leftObj:'🦓',rightCount:3,rightObj:'🦒',op:'add'}}, o:[{val:'4',tag:'err_off_by_one'},{val:'5',tag:'err_off_by_one'},{val:'6'},{val:'7',tag:'err_off_by_one'}], a:2, e:'3 + 3 = 6 in all!', d:'m', s:null, h:'Count on from 3: 4, 5, 6'},
    ...
    {t:'One more than 8 🎃 is how many?',           v:{type:'objectSet',config:{count:8,emoji:'🎃',layout:'grid'}}, o:[{val:'7',tag:'err_off_by_one'},{val:'8',tag:'err_same'},{val:'9'},{val:'10',tag:'err_off_by_one'}], a:2, e:'8 + 1 more = 9!', d:'m', s:null, h:'Count on one more from 8'},
    {t:'Which is greater: 3 or 6?',                v:{type:'twoGroups',config:{leftCount:3,leftObj:'🔵',rightCount:6,rightObj:'🔵',op:'compare'}}, o:[{val:'3',tag:'err_less'},{val:'6'}], a:1, e:'6 is greater than 3!', d:'m', s:null, h:'3 or 6 — which comes later?'},
    ...
    {t:'Is 8 greater than 9?',                     v:{type:'twoGroups',config:{leftCount:8,leftObj:'🔵',rightCount:9,rightObj:'🔵',op:'compare'}}, o:[{val:'yes — 8 is greater',tag:'err_not_equal'},{val:'no — 9 is greater'}], a:1, e:'No! 9 is greater than 8 by 1!', d:'h', s:null, h:'8 or 9 — which comes later when you count?'},
    {t:'Which is less: 8 or 9?',                   v:{type:'twoGroups',config:{leftCount:8,leftObj:'🔵',rightCount:9,rightObj:'🔵',op:'compare'}}, o:[{val:'8'},{val:'9',tag:'err_more'}], a:0, e:'8 is less than 9 — just by 1!', d:'h', s:null, h:'These are very close — which comes first?'},
    ...
    {t:'One more than 5 🐸 is how many?',           v:{type:'objectSet',config:{count:5,emoji:'🐸',layout:'grid'}}, o:[{val:'4',tag:'err_off_by_one'},{val:'5',tag:'err_same'},{val:'6'},{val:'7',tag:'err_off_by_one'}], a:2, e:'5 + 1 more = 6!', d:'m', s:null, h:'Count on one more from 5'},
    {t:'Which is greater: 2 or 6?',                v:{type:'twoGroups',config:{leftCount:2,leftObj:'🔵',rightCount:6,rightObj:'🔵',op:'compare'}}, o:[{val:'2',tag:'err_less'},{val:'6'}], a:1, e:'6 is greater than 2!', d:'m', s:null, h:'2 or 6 — which comes later?'},
    ...
    {t:'One less than 7 🦄 is how many?',           v:{type:'objectSet',config:{count:7,emoji:'🦄',layout:'grid'}}, o:[{val:'5',tag:'err_off_by_one'},{val:'6'},{val:'7',tag:'err_same'},{val:'8',tag:'err_off_by_one'}], a:1, e:'7 take away 1 = 6!', d:'m', s:null, h:'Count back one from 7'},
    {t:'Is 8 equal to 8?',                         v:{type:'twoGroups',config:{leftCount:8,leftObj:'🔵',rightCount:8,rightObj:'🔵',op:'compare'}}, o:[{val:'yes — equal'},{val:'no — not equal',tag:'err_not_equal'}], a:0, e:'8 = 8 — they are equal!', d:'m', s:null, h:'Both say 8 — are they the same?'}
  ]
});
