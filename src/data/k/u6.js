...
_mergeKUnitData(5, {
    ...
    // ── Lesson 1: Flat Shapes (2D) — K.6A ───────────────────────────────────
    {
      ...
      qBank: [
        ...
        },
        {
          ...
          o: [{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square'}],
          a:1, e:'A square has all 4 sides the same length.', d:'e', s:null, h:'Look at both — which has equal sides?'
        },
        {
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['triangle'], label: 'A triangle' } },
          o: [{val:'triangle'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
          a:0, e:'A triangle has 3 sides and 3 corners.', d:'e', s:null, h:'Count the corners: 1, 2, 3'
        },
        {
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['circle'], label: 'A circle' } },
          o: [{val:'circle'},{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
          a:0, e:'A circle is round with no corners.', d:'e', s:null, h:'Perfectly round — no pointy corners'
        },
        {
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['square'], label: 'A square' } },
          o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '📕', layout: 'line' } },
          o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'}],
        ...
        },
        {
          ...
          o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
          a:2, e:'A rectangle has 4 sides — 2 long and 2 short.', d:'e', s:null, h:'4 corners, but the sides are not all equal.'
        },
        ...
        {
          t: 'Look at the mountain. What shape is it?',
          v: { type: 'objectSet', config: { count: 1, emoji: '🏔️', layout: 'line' } },
          o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
          a:1, e:'A mountain peak comes to a point — just like a triangle!', d:'m', s:null, h:'Count the sides going up and down.'
        },
        {
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['rectangle'], label: 'A rectangle' } },
          o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'}],
        ...
        },
        {
          ...
          o: [{val:'square and rectangle'},{val:'triangle and circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square and triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle and rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        // ── hard — orientation, comparisons, classification ──────────────────
        {
          ...
          o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle'},{val:'square',tag:'err_shape_orient'},{val:'rectangle',tag:'err_shape_orient'}],
        ...
        },
        {
          ...
          o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'diamond',tag:'err_shape_orient'},{val:'square'}],
        ...
        },
        {
          ...
          o: [{val:'0',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'1'},{val:'2',tag:'err_off_by_one'},{val:'3',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['rectangle','square'], cols: 2, label: 'A rectangle and a square' } },
          o: [{val:'rectangle'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cube'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    // ── Lesson 2: Solid Shapes (3D) — K.6B, K.6C ────────────────────────────
    {
      ...
      qBank: [
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🍦', layout: 'line' } },
          o: [{val:'cube',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone'},{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cylinder',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🥫', layout: 'line' } },
          o: [{val:'cube',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cylinder'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🧊', layout: 'line' } },
          o: [{val:'cube'},{val:'cone',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cylinder',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🥫', layout: 'line' } },
          o: [{val:'cube',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cylinder'},{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        // ── medium — faces, surfaces, real-world ─────────────────────────────
        {
          ...
          v: null,
          o: [{val:'flat',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'pointed',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'curved'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🧊', layout: 'line' } },
          o: [{val:'4',tag:'err_off_by_one'},{val:'5',tag:'err_off_by_one'},{val:'6'},{val:'8',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🥫', layout: 'line' } },
          o: [{val:'1',tag:'err_off_by_one'},{val:'2'},{val:'3',tag:'err_off_by_one'},{val:'6',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'cube',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'sphere'},{val:'cylinder',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🧊', layout: 'line' } },
          o: [{val:'circle',tag:'err_wrong_solid'},{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🥫', layout: 'line' } },
          o: [{val:'square',tag:'err_wrong_solid'},{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle'},{val:'rectangle',tag:'err_wrong_solid'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'cube',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone',tag:'err_wrong_solid'},{val:'sphere'},{val:'cylinder',tag:'err_wrong_solid'}],
        ...
        // ── hard — properties, comparisons, faces of solids ─────────────────
        {
          ...
          v: null,
          o: [{val:'only flat faces',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'a pointed top',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'a circle on the bottom'},{val:'6 faces',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🧊', layout: 'line' } },
          o: [{val:'4',tag:'err_off_by_one'},{val:'6',tag:'err_off_by_one'},{val:'8'},{val:'12',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        {
          t: 'Which solid has the most flat faces?',
          v: null,
          o: [{val:'sphere (0)',tag:'err_wrong_solid'},{val:'cone (1)',tag:'err_wrong_solid'},{val:'cylinder (2)',tag:'err_wrong_solid'},{val:'cube (6)'}],
          a:3, e:'A cube has 6 flat faces — more than any other solid we know.', d:'h', s:null, h:'Sphere = 0, cone = 1, cylinder = 2, cube = 6'
        },
        {
          t: 'Which solid CANNOT roll?',
          v: null,
          o: [{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cylinder',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cube'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'flat',tag:'err_wrong_solid'},{val:'smaller',tag:'err_size_distractor',patternTag:'pattern_chose_by_size'},{val:'3D — you can hold it'},{val:'a different color',tag:'err_color_distractor',patternTag:'pattern_chose_by_color'}],
        ...
        {
          t: 'A cube and a cylinder — which has MORE flat faces?',
          v: null,
          o: [{val:'cube'},{val:'cylinder',tag:'err_wrong_solid'},{val:'they have the same',tag:'err_equal_confusion',patternTag:'pattern_thinks_equal'},{val:'neither has flat faces',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'}],
          a:0, e:'A cube has 6 flat faces; a cylinder has only 2.', d:'h', s:null, h:'Cube = 6 faces; cylinder = 2 faces'
        },
        {
          t: 'A cylinder can roll on its side. A cube cannot. Why?',
          v: null,
          o: [{val:'the cube is heavier',tag:'err_size_distractor',patternTag:'pattern_chose_by_size'},{val:'the cylinder has a curved surface'},{val:'the cube has more faces',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'the cylinder is smaller',tag:'err_size_distractor',patternTag:'pattern_chose_by_size'}],
          a:1, e:'A curved surface lets the cylinder roll.', d:'h', s:null, h:'What does a curved surface allow?'
        },
        {
          t: 'Which solid is most like a cylinder but has a pointy top instead of a flat circle?',
          v: null,
          o: [{val:'cube',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone'},{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cylinder itself',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
          a:1, e:'A cone has a round base like a cylinder — but comes to a point at the top instead!', d:'m', s:null, h:'It has a curved side and a round bottom — but pointy on top.'
        },
        {
          t: 'A cone placed on a flat floor will roll in a circle. Why?',
          v: { type: 'objectSet', config: { count: 1, emoji: '🍦', layout: 'line' } },
          o: [{val:'it has no flat faces',tag:'err_wrong_solid'},{val:'one end is wider than the other'},{val:'it is the same width all the way',tag:'err_confused',patternTag:'pattern_needs_review'},{val:'it is too heavy to roll straight',tag:'err_confused',patternTag:'pattern_needs_review'}],
          a:1, e:'A cone is wide at the bottom and narrows to a point — so it curves as it rolls.', d:'h', s:null, h:'Think about how wide the bottom is compared to the top.'
        }
      ]
    },
    ...
    // ── Lesson 3: Shape Attributes — Sides & Corners — K.6D ─────────────────
    {
      ...
      qBank: [
        // ── easy — basic attribute counting ─────────────────────────────────
        {
          ...
          v: { type: 'shapes', config: { items: ['triangle'], label: 'A triangle' } },
          o: [{val:'2',tag:'err_off_by_one'},{val:'3'},{val:'4',tag:'err_off_by_one'},{val:'5',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle'], label: 'A circle' } },
          o: [{val:'0'},{val:'1',tag:'err_off_by_one'},{val:'2',tag:'err_off_by_one'},{val:'4',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['square'], label: 'A square' } },
          o: [{val:'2',tag:'err_off_by_one'},{val:'3',tag:'err_off_by_one'},{val:'4'},{val:'6',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['square'], label: 'A square' } },
          o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'},{val:'none of them',tag:'err_confused',patternTag:'pattern_needs_review'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['square','triangle'], cols: 2, label: 'A square and a triangle' } },
          o: [{val:'0',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'1'},{val:'2',tag:'err_off_by_one'},{val:'4',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
          a:1, e:'Square has 4; triangle has 3. 4 − 3 = 1.', d:'m', s:null, h:'Count each, then find the difference'
        },
        {
          t: 'Tap the rectangle.',
          v: { type: 'shapes', config: { items: ['square','rectangle'], cols: 2, label: 'A square and a rectangle' } },
          o: [{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'}],
        ...
        // ── hard — totals, comparisons, combined reasoning ───────────────────
        {
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['square'], label: 'A square' } },
          o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['rectangle'], label: 'A rectangle' } },
          o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          o: [{val:'triangle'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    // ── Lesson 4: Sort & Create Shapes — K.6E, K.6F ─────────────────────────
    {
      ...
      qBank: [
        // ── easy — sorting basics, drawing ───────────────────────────────────
        {
          ...
          v: { type: 'shapes', config: { items: ['circle','triangle','square','rectangle'], cols: 2, label: 'Four shapes' } },
          o: [{val:'circles only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangles only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'squares and rectangles'},{val:'circles and triangles',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle','triangle','square','rectangle'], cols: 2, label: 'Four shapes' } },
          o: [{val:'circles only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangles only'},{val:'squares only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangles only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          o: [{val:'circle',tag:'err_shape_sort'},{val:'triangle',tag:'err_shape_sort'},{val:'rectangle'},{val:'they are the same',tag:'err_equal_confusion',patternTag:'pattern_thinks_equal'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle','triangle','rectangle'], cols: 3, label: 'A circle, a triangle, and a rectangle' } },
          o: [{val:'circle'},{val:'triangle',tag:'err_shape_sort'},{val:'rectangle',tag:'err_shape_sort'},{val:'they are the same',tag:'err_equal_confusion',patternTag:'pattern_thinks_equal'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle','triangle','square','rectangle'], cols: 2, label: 'Four shapes' } },
          o: [{val:'circles and triangles',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangles only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'squares and rectangles'},{val:'circles only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle','triangle','square','rectangle'], cols: 2, label: 'Four shapes' } },
          o: [{val:'squares and rectangles',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangles and squares',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circles'},{val:'triangles only',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle','triangle','square','rectangle'], cols: 2, label: 'Four shapes' } },
          o: [{val:'triangle and circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square and rectangle'},{val:'triangle and square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle and rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['triangle'], label: 'A triangle' } },
          o: [{val:'round',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'not round'},{val:'both',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'neither',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle','triangle','square','rectangle'], cols: 2, label: 'Four shapes' } },
          o: [{val:'circles',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'squares',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangles'},{val:'rectangles',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['square'], label: 'A square' } },
          o: [{val:'3',tag:'err_off_by_one'},{val:'4'},{val:'5',tag:'err_off_by_one'},{val:'6',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: { type: 'objectSet', config: { count: 1, emoji: '🧊', layout: 'line' } },
          o: [{val:'flat',tag:'err_wrong_solid'},{val:'3D solid'},{val:'both',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'neither',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['circle'], label: 'A circle' } },
          o: [{val:'flat'},{val:'3D solid',tag:'err_wrong_solid'},{val:'both',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'neither',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'triangle and square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle and sphere'},{val:'square and cube',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'triangle and cone',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['triangle'], label: 'A triangle' } },
          o: [{val:'no — 4 or more',tag:'err_off_by_one'},{val:'yes — fewer than 4'},{val:'both',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'neither',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'square and rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle and circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle and sphere'},{val:'triangle and rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
        ...
        // ── hard — orientation, multi-step sorting, attributes ───────────────
        {
          ...
          t: 'What shape is this?',
          v: { type: 'shapes', config: { items: ['triangle'], rotation: 90, label: 'A tilted triangle' } },
          o: [{val:'square',tag:'err_shape_orient'},{val:'triangle'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle',tag:'err_shape_orient'}],
        ...
        },
        {
          ...
          o: [{val:'1',tag:'err_off_by_one'},{val:'2'},{val:'3',tag:'err_off_by_one'},{val:'4',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          o: [{val:'color',tag:'err_color_distractor',patternTag:'pattern_chose_by_color'},{val:'size',tag:'err_size_distractor',patternTag:'pattern_chose_by_size'},{val:'number of sides'},{val:'number of letters in the name',tag:'err_confused',patternTag:'pattern_needs_review'}],
        ...
        },
        {
          ...
          v: { type: 'shapes', config: { items: ['square'], label: 'A square' } },
          o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle',tag:'err_off_by_one'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'3 straight lines',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'4 straight lines',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'one curved line'},{val:'1 straight line',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
        ...
        },
        {
          ...
          v: null,
          o: [{val:'triangle',tag:'err_off_by_one'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'},{val:'none of these',tag:'err_confused',patternTag:'pattern_needs_review'}],
        ...
        // ── tapGroup: 5 required interactive variations ───────────────────────
        {
          ...
          t:'Tap shapes with more than 3 sides.',
          prompt:'Tap shapes with more than 3 sides.',
          hint:'Count the sides — is it more than 3?',
          explanation:'Squares and rectangles have 4 sides — more than 3!',
          answer:{},
          v:{ type:'tapGroup', config:{ mode:'multi', shapes:[
            {id:'s1',shape:'square',   corners:4,correct:true},
            {id:'s2',shape:'triangle', corners:3,correct:false},
          ...
          tags:['shapes','sort','sides','square','rectangle'],
          difficulty:'medium', standard:'K.6E',
          intervention:{ teach:{ text:'Squares have 4 sides, rectangles have 4 sides — both more than 3!', highlight:['square','rectangle'] }, retry:{ strategy:'similar', matchTags:['sort','sides'] } }
        },
        {
          id:'k-u6-l4-tg-02', type:'tapGroup', grade:'K', unit:6, lesson:4,
          t:'Tap all the rectangles.',
          prompt:'Tap all the rectangles.',
          hint:'Rectangles have 4 corners — but the sides are NOT all the same length!',
          explanation:'Rectangles have 4 corners — but their long sides and short sides are different lengths!',
          answer:{},
          v:{ type:'tapGroup', config:{ mode:'multi', shapes:[
            {id:'s1',shape:'rectangle',corners:4,correct:true},
            {id:'s2',shape:'circle',   corners:0,correct:false},
            {id:'s3',shape:'rectangle',corners:4,correct:true},
            {id:'s4',shape:'square',   corners:4,correct:false},
            {id:'s5',shape:'triangle', corners:3,correct:false}
          ]}},
          visual:{ type:'tapGroup', config:{ mode:'multi', shapes:[
            {id:'s1',shape:'rectangle',corners:4,correct:true},
            {id:'s2',shape:'circle',   corners:0,correct:false},
          ...
          tags:['shapes','rectangle','identify','sort'],
          difficulty:'medium', standard:'K.6E',
          intervention:{ teach:{ text:'Rectangles have 4 corners but their sides are not all equal!', highlight:['rectangle'] }, retry:{ strategy:'similar', matchTags:['rectangle','identify'] } }
        },
        {
          id:'k-u6-l4-tg-03', type:'tapGroup', grade:'K', unit:6, lesson:4,
          t:'Tap shapes with fewer than 4 sides.',
          prompt:'Tap shapes with fewer than 4 sides.',
          hint:'Circle has 0 sides, triangle has 3 — both fewer than 4!',
          explanation:'Circle (0 sides) and triangle (3 sides) both have fewer than 4 sides!',
          answer:{},
          v:{ type:'tapGroup', config:{ mode:'multi', shapes:[
            {id:'s1',shape:'circle',   corners:0,correct:true},
            ...
            {id:'s5',shape:'circle',   corners:0,correct:true}
          ]}},
          visual:{ type:'tapGroup', config:{ mode:'multi', shapes:[
            {id:'s1',shape:'circle',   corners:0,correct:true},
            {id:'s2',shape:'triangle', corners:3,correct:true},
          ...
          tags:['shapes','sort','sides','circle','triangle'],
          difficulty:'medium', standard:'K.6E',
          intervention:{ teach:{ text:'Circle has 0 sides, triangle has 3 sides — both fewer than 4!', highlight:['circle','triangle'] }, retry:{ strategy:'similar', matchTags:['sort','sides'] } }
        },
        {
          id:'k-u6-l4-tg-04', type:'tapGroup', grade:'K', unit:6, lesson:4,
          t:'Tap all the squares.',
          prompt:'Tap all the squares.',
          hint:'Squares have 4 equal sides — all the same length!',
          explanation:'Squares have 4 equal sides — all the same length!',
          answer:{},
          v:{ type:'tapGroup', config:{ mode:'multi', shapes:[
            {id:'s1',shape:'square',   corners:4,correct:true},
            {id:'s2',shape:'circle',   corners:0,correct:false},
            {id:'s3',shape:'rectangle',corners:4,correct:false},
            {id:'s4',shape:'square',   corners:4,correct:true},
            {id:'s5',shape:'triangle', corners:3,correct:false}
          ]}},
          visual:{ type:'tapGroup', config:{ mode:'multi', shapes:[
            {id:'s1',shape:'square',   corners:4,correct:true},
          ...
          tags:['shapes','square','identify','sort'],
          difficulty:'medium', standard:'K.6E',
          intervention:{ teach:{ text:'Squares have 4 equal sides — all the same length!', highlight:['square'] }, retry:{ strategy:'similar', matchTags:['square','identify'] } }
        },
        {
  ...
  testBank: [
    ...
    {lessonId:'ku5l1', 
      ...
      v: { type: 'shapes', config: { items: ['circle'], label: 'A circle' } },
      o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    {lessonId:'ku5l1', 
      ...
      v: { type: 'objectSet', config: { count: 1, emoji: '🪙', layout: 'line' } },
      o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle'},{val:'square',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    {lessonId:'ku5l1', 
      ...
      v: { type: 'objectSet', config: { count: 1, emoji: '🪁', layout: 'line' } },
      o: [{val:'triangle',tag:'err_off_by_one'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'},{val:'none of them',tag:'err_confused',patternTag:'pattern_needs_review'}],
    ...
    {lessonId:'ku5l1', 
      t: 'Tap the shape with all sides equal.',
      v: { type: 'shapes', config: { items: ['square','rectangle'], cols: 2, label: 'A square and a rectangle' } },
      o: [{val:'square'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    {lessonId:'ku5l2', 
      ...
      v: null,
      o: [{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone'},{val:'cylinder',tag:'err_off_by_one'},{val:'cube',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    {lessonId:'ku5l2', 
      ...
      v: { type: 'objectSet', config: { count: 1, emoji: '🧊', layout: 'line' } },
      o: [{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cone',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cylinder',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'cube'}],
    ...
    {lessonId:'ku5l2', 
      ...
      v: null,
      o: [{val:'it is flat',tag:'err_wrong_solid'},{val:'it has corners',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'it is 3D — you can hold it'},{val:'it has 4 faces',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
    ...
    {lessonId:'ku5l2', 
      ...
      v: null,
      o: [{val:'0',tag:'err_off_by_one'},{val:'1',tag:'err_off_by_one'},{val:'2'},{val:'6',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
    ...
    {lessonId:'ku5l2', 
      ...
      v: null,
      o: [{val:'cube',tag:'err_wrong_solid'},{val:'cone'},{val:'sphere',tag:'err_wrong_solid'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    {lessonId:'ku5l3', 
      t: 'What shape is this?',
      v: { type: 'shapes', config: { items: ['square'], label: 'A square' } },
      o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square'}],
    ...
    {lessonId:'ku5l3', 
      ...
      v: null,
      o: [{val:'triangle and square',tag:'err_off_by_one'},{val:'circle and triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'square and rectangle'},{val:'triangle and circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    {lessonId:'ku5l3', 
      ...
      v: null,
      o: [{val:'triangle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'rectangle'},{val:'sphere',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'}],
    ...
    {lessonId:'ku5l4', 
      ...
      v: { type: 'shapes', config: { items: ['triangle'], label: 'A triangle' } },
      o: [{val:'0 sides',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'2 sides',tag:'err_off_by_one'},{val:'3 sides'},{val:'4 sides',tag:'err_off_by_one'}],
      a:2, e:'Triangles always have 3 sides.', d:'e', s:null, h:'Triangle = 3 sides!'
    },
    {lessonId:'ku5l4', 
      t: 'Which group would you sort circles into?',
      v: { type: 'shapes', config: { items: ['circle'], label: 'A circle' } },
      o: [{val:'3 corners',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'4 corners',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'no corners'},{val:'1 corner',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
      a:2, e:'Circles have zero corners.', d:'e', s:null, h:'Circles are round — no corners!'
    },
    {lessonId:'ku5l4', 
      t: 'Which group would you sort cubes into?',
      v: { type: 'objectSet', config: { count: 1, emoji: '🧊', layout: 'line' } },
      o: [{val:'flat shapes',tag:'err_wrong_solid'},{val:'3D solids'},{val:'curved shapes',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'},{val:'shapes with no corners',tag:'err_2d_3d_confuse',patternTag:'pattern_confuses_2d_3d'}],
      a:1, e:'A cube is a 3D solid — you can hold it.', d:'e', s:null, h:'Can you hold a cube?'
    },
    {lessonId:'ku5l4', 
      t: 'To draw a circle, you draw ___?',
      v: null,
      o: [{val:'3 straight lines',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'4 straight lines',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'no straight lines — a smooth curve'},{val:'1 straight line',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
    ...
    {lessonId:'ku5l4', 
      ...
      v: { type: 'shapes', config: { items: ['rectangle','square'], cols: 2, label: 'A rectangle and a square' } },
      o: [{val:'sides are all equal',tag:'err_equal_confusion',patternTag:'pattern_thinks_equal'},{val:'both are round',tag:'err_equal_confusion',patternTag:'pattern_thinks_equal'},{val:'both have 4 sides and 4 corners'},{val:'both have 3 corners',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
    ...
    {lessonId:'ku5l4', 
      ...
      v: null,
      o: [{val:'both have corners',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'},{val:'both are flat',tag:'err_wrong_solid'},{val:'both are round with curved surfaces'},{val:'both have 4 sides',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
    ...
    {lessonId:'ku5l4', 
      ...
      v: { type: 'shapes', config: { items: ['triangle'], rotation: 180, label: 'An upside-down triangle' } },
      o: [{val:'it has no sides when flipped',tag:'err_shape_orient'},{val:'its sides and corners stay the same'},{val:'it becomes a square when flipped',tag:'err_shape_orient'},{val:'you cannot sort a flipped shape',tag:'err_confused',patternTag:'pattern_needs_review'}],
    ...
    {lessonId:'ku5l4', 
      ...
      v: null,
      o: [{val:'1',tag:'err_under_count'},{val:'2',tag:'err_off_by_one'},{val:'3'},{val:'4',tag:'err_corner_count',patternTag:'pattern_wrong_corner_count'}],
    ...
    {lessonId:'ku5l4', 
      ...
      v: { type: 'shapes', config: { items: ['triangle','rectangle'], cols: 2, label: 'A triangle and a rectangle' } },
      o: [{val:'by color',tag:'err_color_distractor',patternTag:'pattern_chose_by_color'},{val:'by size',tag:'err_size_distractor',patternTag:'pattern_chose_by_size'},{val:'by number of sides'},{val:'by which is taller',tag:'err_size_distractor',patternTag:'pattern_chose_by_size'}],
    ...
    {lessonId:'ku5l4', 
      ...
      v: { type: 'shapes', config: { items: ['circle','triangle','rectangle'], cols: 3, label: 'A circle, a triangle, and a rectangle' } },
      o: [{val:'circle',tag:'err_shape_confuse',patternTag:'pattern_wrong_shape'},{val:'triangle',tag:'err_off_by_one'},{val:'rectangle'},{val:'they all have the same',tag:'err_equal_confusion',patternTag:'pattern_thinks_equal'}],
