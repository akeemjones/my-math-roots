  ...
  _mergeKUnitData(9, {
    lessons: [
      ...
      // ── Lesson 3: Identify Coins — K.4A ────────────────────────────────────
      {
        ...
        examples: [
          {
            c: '#FFB300',
            tag: 'Penny',
            p: 'Look at the brown coin. What is it called? ' + singleCoin('penny') + '',
            v: null,
            s: 'That is a PENNY! Brown, copper color.',
            a: 'Penny ✅'
          },
          {
            c: '#F57C00',
        ...
        practice: [
          {q:'The only BROWN coin is called a ____', a:'Penny', h:'It is the only brown coin', e:'Penny — copper-colored, only brown coin ✅'},
          {q:'The smallest silver coin is called a ____', a:'Dime', h:'Tiny but worth ten', e:'Dime — smallest of all coins ✅'},
          {q:'The biggest silver coin is called a ____', a:'Quarter', h:'Biggest of the four', e:'Quarter — the biggest coin ✅'}
        ],
        qBank: [
          // ── easy (14) ────────────────────────────────────────────────────
          {t:'What coin is this?', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — the only brown coin.', d:'e', s:singleCoin('penny'), h:'The only brown coin'},
          {t:'What coin is this?', v:null, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_wrong_coin'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, bigger than a dime.', d:'e', s:singleCoin('nickel'), h:'Bigger than a penny, silver'},
          ...
          {t:'What coin is this?', v:null, o:[{val:'penny'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — copper color, only brown coin.', d:'e', s:singleCoin('penny'), h:'Only brown coin'},
          {t:'What coin is this?', v:null, o:[{val:'nickel'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, not smallest, not biggest.', d:'e', s:singleCoin('nickel'), h:'Silver, not smallest, not biggest'},
          {t:'What coin is this?', v:null, o:[{val:'dime'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — the smallest coin.', d:'e', s:singleCoin('dime'), h:'The smallest silver coin'},
          {t:'What coin is this?', v:null, o:[{val:'quarter'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter — biggest silver coin.', d:'e', s:singleCoin('quarter'), h:'Biggest of the four'},
          {t:'Tap the 1¢ coin.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — the only brown coin.', d:'e', s:null, h:'The brown coin'},
          {t:'Tap the 25¢ coin.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter — the biggest silver coin.', d:'e', s:null, h:'Biggest silver coin'},
          ...
          {t:'Tap the 5¢ coin.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, between dime and quarter.', d:'m', s:null, h:'Silver, between dime and quarter'},
          {t:'Tap the 10¢ coin.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — the smallest coin.', d:'m', s:null, h:'The smallest coin'},
          {t:'Find the nickel.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'nickel'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, bigger than a dime.', d:'m', s:null, h:'Silver, bigger than a dime'},
          {t:'Find the penny.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'penny'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — brown, the only copper coin.', d:'m', s:null, h:'Brown/copper'},
          ...
          // ── hard (9) ──────────────────────────────────────────────────────
          {t:'What coin is this?', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — the smallest coin.', d:'h', s:singleCoin('dime'), h:'Smallest silver coin'},
          {t:'What coin is this?', v:null, o:[{val:'nickel'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, between dime and quarter.', d:'h', s:singleCoin('nickel'), h:'Between dime and quarter in size'},
          ...
          {t:'Find the penny.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — the only brown coin.', d:'h', s:null, h:'The brown coin'},
          {t:'Find the dime.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — the smallest silver coin.', d:'h', s:null, h:'The smallest coin'},
          {t:'Find the nickel.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, bigger than a dime.', d:'h', s:null, h:'Silver, between dime and quarter'},
          {t:'Find the quarter.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter — the biggest silver coin.', d:'h', s:null, h:'Biggest silver coin'},
      ...
      // ── Lesson 4: Compare Coins — K.4A ─────────────────────────────────────
      {
        ...
        examples: [
          ...
          },
          {
            ...
            v: null,
            s: 'Another penny would match — same brown color, same size.',
            a: 'Another penny ✅'
          }
        ],
        practice: [
    ...
    testBank: [
      ...
      {lessonId:'ku8l3', t:'What coin is this?', s:singleCoin('penny'), o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — the only brown coin.', d:'e'},
      {lessonId:'ku8l3', t:'What coin is this?', s:singleCoin('nickel'), o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_wrong_coin'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, bigger than a dime.', d:'e'},
      {lessonId:'ku8l3', t:'What coin is this?', s:singleCoin('dime'), o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_wrong_coin'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — the smallest coin.', d:'e'},
      {lessonId:'ku8l3', t:'What coin is this?', s:singleCoin('quarter'), o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_wrong_coin'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter — biggest silver coin.', d:'e'},
      {lessonId:'ku8l3', t:'What coin is this?', s:singleCoin('penny'), o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — the only brown coin.', d:'e'},
      {lessonId:'ku8l3', t:'What coin is this?', s:singleCoin('quarter'), o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter — the biggest silver coin.', d:'e'},
      ...
      {lessonId:'ku8l3', t:'Tap the 5¢ coin.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, between dime and quarter.', d:'m'},
      {lessonId:'ku8l3', t:'Tap the 10¢ coin.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — the smallest coin.', d:'m'},
      {lessonId:'ku8l3', t:'Find the nickel.', s:singleCoin('nickel'), o:[{val:'nickel'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver, bigger than a dime.', d:'m'},
      ...
      {lessonId:'ku8l3', t:'Tap the 1¢ coin.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — the only brown coin.', d:'h'},
