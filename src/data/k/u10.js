  ...
  _mergeKUnitData(9, {
    lessons: [
      ...
      // ── Lesson 3: Identify Coins — K.4A ────────────────────────────────────
      {
        ...
        qBank: [
          // ── easy (14) — direct identification, image shown ───────────────
          {t:'What coin is this?', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — brown/copper, with Lincoln.', d:'e', s:singleCoin('penny'), h:'It is the only brown coin'},
          ...
          {t:'What coin is this?', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_wrong_coin'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — the smallest coin, with Roosevelt.', d:'e', s:singleCoin('dime'), h:'Smallest of all four coins'},
          {t:'What coin is this?', v:null, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_wrong_coin'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter — biggest silver coin, with Washington.', d:'e', s:singleCoin('quarter'), h:'Biggest silver coin'},
          {t:'Find the PENNY. Which coin is shown?', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_wrong_coin'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — brown/copper-colored.', d:'e', s:null, h:'The brown coin'},
          {t:'Which coin is the DIME?', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Yes — that is the DIME, the smallest coin.', d:'e', s:null, h:'The smallest one'},
          {t:'Which coin is the NICKEL?', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'nickel'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Yes — that is the NICKEL, with Jefferson.', d:'e', s:null, h:'Bigger silver coin, but not biggest'},
          {t:'Which coin is the QUARTER?', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Yes — that is the QUARTER, biggest silver coin.', d:'e', s:null, h:'Biggest silver coin'},
          ...
          {t:'What coin is this?', v:null, o:[{val:'nickel'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — silver and round, Jefferson.', d:'e', s:singleCoin('nickel'), h:'Silver, not the smallest, not the biggest'},
          ...
          {t:'Which coin shows ABRAHAM LINCOLN?', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny — Lincoln is on the penny.', d:'e', s:null, h:'Lincoln is on the brown coin'},
          {t:'Which coin shows GEORGE WASHINGTON?', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter — Washington is on the quarter.', d:'e', s:null, h:'Biggest silver coin'},

          // ── medium (13) — pick by clue, no image, OR image + clue ────────
          {t:'Which coin is the SMALLEST?', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Dime is the smallest coin.', d:'m', s:null, h:'Tiny silver coin'},
          {t:'Which coin is the BIGGEST silver coin?', v:null, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Quarter is the biggest silver coin.', d:'m', s:null, h:'Biggest of the four'},
          {t:'Which coin is BROWN/copper colored?', v:null, o:[{val:'penny'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny is the only brown/copper coin.', d:'m', s:null, h:'The other three are silver'},
          {t:'Which coin shows JEFFERSON?', v:null, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel — Jefferson is on the nickel.', d:'m', s:null, h:'Silver, between the dime and quarter in size'},
          {t:'Which coin shows FRANKLIN ROOSEVELT?', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime — Roosevelt is on the dime.', d:'m', s:null, h:'The smallest coin'},
          {t:'Find the NICKEL.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'nickel'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'That coin is the NICKEL — silver, Jefferson.', d:'m', s:null, h:'Silver, bigger than a dime'},
          {t:'Find the PENNY.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'penny'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'That coin is the PENNY — brown, Lincoln.', d:'m', s:null, h:'Brown/copper'},
          {t:'Find the DIME.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'That coin is the DIME — smallest coin.', d:'m', s:null, h:'Smallest of all four'},
          {t:'Find the QUARTER.', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'quarter'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'That coin is the QUARTER — biggest silver coin.', d:'m', s:null, h:'Biggest silver coin'},
          {t:'A silver coin SMALLER than a nickel is a…', v:{type:'coinChoices',config:{coins:['penny','nickel','dime','quarter']}}, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'all the same',tag:'err_same'}], a:0, e:'Dime — smaller than a nickel.', d:'m', s:null, h:'Smallest of all'},
          {t:'A silver coin BIGGER than a nickel is a…', v:null, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'all the same',tag:'err_same'}], a:0, e:'Quarter — bigger than a nickel.', d:'m', s:null, h:'Biggest of the four'},
          {t:'A coin that is NOT silver is a…', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny is brown — not silver.', d:'m', s:null, h:'Color matters'},
          {t:'Which coin name starts with the letter Q?', v:null, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter starts with Q.', d:'m', s:null, h:'Q-U-A-R-T-E-R'},

          // ── hard (9) — multi-clue, side-by-side, attribute reasoning ─────
          {t:'A child sees a SMALL silver coin. It is most likely a…', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Small + silver = DIME.', d:'h', s:null, h:'Smallest silver coin'},
          {t:'A coin is BIG and silver, with a man\'s face. Most likely a…', v:null, o:[{val:'quarter'},{val:'dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Big + silver = QUARTER (Washington).', d:'h', s:null, h:'Biggest silver coin'},
          {t:'A coin is round and BROWN. It is a…', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Brown = PENNY (the only brown coin).', d:'h', s:null, h:'Color is the clue'},
          {t:'A silver coin BETWEEN the dime and the quarter in size is a…', v:null, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Nickel — middle size between dime and quarter.', d:'h', s:null, h:'Not smallest, not biggest'},
          {t:'You see Lincoln on the coin. The coin is a…', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny shows Lincoln.', d:'h', s:null, h:'Lincoln = penny'},
          {t:'You see Roosevelt on the coin. The coin is a…', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Dime shows Roosevelt.', d:'h', s:null, h:'Roosevelt = dime'},
          {t:'You see Jefferson on the coin. The coin is a…', v:null, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Nickel shows Jefferson.', d:'h', s:null, h:'Jefferson = nickel'},
          {t:'You see Washington on the coin. The coin is a…', v:null, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Quarter shows Washington.', d:'h', s:null, h:'Washington = quarter'},
          {t:'Which coin is silver AND smaller than the nickel?', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'all are same',tag:'err_same'}], a:0, e:'Dime — silver AND smallest.', d:'h', s:null, h:'Tiny silver coin'}
        ]
      },
      ...
      // ── Lesson 4: Compare Coins — K.4A ─────────────────────────────────────
      {
        ...
        qBank: [
          ...
          {t:'Which coin LOOKS DIFFERENT (different color)?', v:null, o:[{val:'penny (brown — others are silver)'},{val:'dime',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'all the same',tag:'err_same',patternTag:'err_visual_confusion'}], a:0, e:'Penny is brown — the dime and nickel are silver.', d:'e', s:'<div style="display:flex;align-items:center;justify-content:center;gap:8px;padding:8px 0">'+coinSVG('penny',80)+coinSVG('dime',80)+coinSVG('nickel',80)+'</div>', h:'Color is the clue'},

          // ── medium (13) — multi-coin sets, ordering, contextual ──────────
          {t:'Which is the BIGGEST coin shown?', v:null, o:[{val:'quarter'},{val:'penny',tag:'err_less',patternTag:'err_size_confusion'},{val:'dime',tag:'err_less',patternTag:'err_size_confusion'},{val:'all the same',tag:'err_same'}], a:0, e:'Quarter — the biggest of the three shown.', d:'m', s:'<div style="display:flex;align-items:center;justify-content:center;gap:8px;padding:8px 0">'+coinSVG('penny',80)+coinSVG('dime',80)+coinSVG('quarter',80)+'</div>', h:'Quarters are biggest'},
          {t:'Which is the SMALLEST coin shown?', v:null, o:[{val:'dime'},{val:'penny',tag:'err_more',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_more',patternTag:'err_size_confusion'},{val:'all the same',tag:'err_same'}], a:0, e:'Dime — smallest of all coins.', d:'m', s:'<div style="display:flex;align-items:center;justify-content:center;gap:8px;padding:8px 0">'+coinSVG('penny',80)+coinSVG('quarter',80)+coinSVG('dime',80)+'</div>', h:'Dime is the smallest'},
          {t:'Order from SMALLEST to BIGGEST: dime, quarter, nickel. The smallest is…', v:null, o:[{val:'dime'},{val:'nickel',tag:'err_more',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_more',patternTag:'err_size_confusion'},{val:'all same',tag:'err_same'}], a:0, e:'Dime is the smallest.', d:'m', s:null, h:'Dime is smallest of all'},
          {t:'Order from SMALLEST to BIGGEST: dime, quarter, nickel. The biggest is…', v:null, o:[{val:'quarter'},{val:'dime',tag:'err_less',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_less',patternTag:'err_size_confusion'},{val:'all same',tag:'err_same'}], a:0, e:'Quarter is the biggest.', d:'m', s:null, h:'Quarter is biggest'},
          {t:'Two coins are silver and the SAME SIZE. They are BOTH…', v:null, o:[{val:'two of the same coin (e.g., two dimes)'},{val:'always a penny and a dime',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'always a quarter and a nickel',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'all same',tag:'err_same'}], a:0, e:'Same size + same color = same coin (two of the same).', d:'m', s:null, h:'Match means same coin'},
          {t:'A penny and a dime — which is BIGGER?', v:null, o:[{val:'penny'},{val:'dime',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Penny is bigger than a dime.', d:'m', s:twoCoins('penny','dime'), h:'Dime is the smallest'},
          {t:'A nickel and a quarter — which is BIGGER?', v:null, o:[{val:'quarter'},{val:'nickel',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Quarter — biggest of the four.', d:'m', s:twoCoins('nickel','quarter'), h:'Quarter is biggest'},
          {t:'A nickel and a dime — which is SMALLER?', v:null, o:[{val:'dime'},{val:'nickel',tag:'err_more',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Dime is smaller — even though it can be worth more, it is smaller in SIZE.', d:'m', s:twoCoins('nickel','dime'), h:'We compare size, not value'},
          {t:'A penny and a quarter — which is SMALLER?', v:null, o:[{val:'penny'},{val:'quarter',tag:'err_more',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Penny is smaller than a quarter.', d:'m', s:twoCoins('penny','quarter'), h:'Quarter is biggest'},
          {t:'Two pennies are placed side by side. They are…', v:null, o:[{val:'the same size and color'},{val:'different colors',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'different sizes',tag:'err_confused',patternTag:'err_size_confusion'},{val:'always silver',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Same coin = same size and color.', d:'m', s:null, h:'Same coin matches itself'},
          {t:'Two dimes are placed side by side. They are…', v:null, o:[{val:'the same size and silver'},{val:'one bigger than the other',tag:'err_confused',patternTag:'err_size_confusion'},{val:'different colors',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'one is brown',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Two dimes look the same — small and silver.', d:'m', s:null, h:'Same coin = identical'},
          {t:'Which group has the BIGGEST coin?', v:null, o:[{val:'a group with a quarter'},{val:'a group with only dimes',tag:'err_more',patternTag:'err_size_confusion'},{val:'a group with only pennies',tag:'err_more',patternTag:'err_size_confusion'},{val:'a group with only nickels',tag:'err_more',patternTag:'err_size_confusion'}], a:0, e:'Any group with a quarter has the biggest coin.', d:'m', s:null, h:'Quarter is biggest'},
          {t:'Which group has the SMALLEST coin?', v:null, o:[{val:'a group with a dime'},{val:'a group with only pennies',tag:'err_less',patternTag:'err_size_confusion'},{val:'a group with only nickels',tag:'err_less',patternTag:'err_size_confusion'},{val:'a group with only quarters',tag:'err_less',patternTag:'err_size_confusion'}], a:0, e:'Any group with a dime has the smallest coin.', d:'m', s:null, h:'Dime is smallest'},

          // ── hard (9) — order, attribute combos, find odd one ─────────────
          {t:'In order from SMALLEST to BIGGEST, which is RIGHT?', v:null, o:[{val:'dime, penny, nickel, quarter'},{val:'penny, dime, nickel, quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter, nickel, penny, dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'all the same size',tag:'err_same',patternTag:'err_visual_confusion'}], a:0, e:'Smallest to biggest: dime, penny, nickel, quarter.', d:'h', s:null, h:'Dime smallest, quarter biggest'},
          {t:'In order from BIGGEST to SMALLEST, which is RIGHT?', v:null, o:[{val:'quarter, nickel, penny, dime'},{val:'dime, penny, nickel, quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'penny, quarter, nickel, dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'all the same size',tag:'err_same'}], a:0, e:'Biggest to smallest: quarter, nickel, penny, dime.', d:'h', s:null, h:'Quarter biggest, dime smallest'},
          {t:'A coin is silver AND smaller than a penny. It is a…', v:null, o:[{val:'dime'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'penny',tag:'err_same',patternTag:'err_coin_confusion'}], a:0, e:'Silver + smaller than penny = DIME.', d:'h', s:null, h:'Tiny silver coin'},
          {t:'A coin is silver AND bigger than a penny. It is most likely a…', v:null, o:[{val:'nickel or quarter'},{val:'dime only',tag:'err_confused',patternTag:'err_size_confusion'},{val:'penny',tag:'err_same',patternTag:'err_coin_confusion'},{val:'no coin like that',tag:'err_confused'}], a:0, e:'Nickels and quarters are silver and bigger than pennies.', d:'h', s:null, h:'Silver and bigger'},
          {t:'Which TWO coins MATCH (look the same)?', v:null, o:[{val:'two pennies'},{val:'a penny and a dime',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'a quarter and a dime',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'a penny and a nickel',tag:'err_confused',patternTag:'err_visual_confusion'}], a:0, e:'Only TWO of the SAME coin match.', d:'h', s:null, h:'Same coin matches itself'},
          {t:'Find the ODD coin out: penny, penny, dime.', v:null, o:[{val:'dime (different — silver and small)'},{val:'first penny',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'second penny',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'all are the same',tag:'err_same',patternTag:'err_visual_confusion'}], a:0, e:'The dime is the odd one — silver and small.', d:'h', s:null, h:'One does not match'},
          {t:'Find the ODD coin out: dime, dime, quarter.', v:null, o:[{val:'quarter (much bigger)'},{val:'first dime',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'second dime',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'all the same',tag:'err_same',patternTag:'err_visual_confusion'}], a:0, e:'The quarter is the odd one — much bigger than the dimes.', d:'h', s:null, h:'One is bigger'},
          {t:'Find the ODD coin out: nickel, nickel, penny.', v:null, o:[{val:'penny (brown — others are silver)'},{val:'first nickel',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'second nickel',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'all the same',tag:'err_same',patternTag:'err_visual_confusion'}], a:0, e:'The penny is brown — odd one out.', d:'h', s:null, h:'Color is the clue'},
          {t:'A child says "the bigger coin is always worth more." Is that true?', v:null, o:[{val:'NO — a dime is smaller than a penny but worth more'},{val:'YES — bigger always means more',tag:'err_more',patternTag:'err_size_confusion'},{val:'always the same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'NO — size doesn\'t equal value. The dime is small but worth more than the penny.', d:'h', s:null, h:'Size and value are not the same'}
        ]
      }
    ],
    ...
    testBank: [
      ...
      {lessonId:'ku8l3', t:'Which coin shows LINCOLN?', s:singleCoin('penny'), o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Lincoln is on the penny.', d:'e'},
      {lessonId:'ku8l3', t:'Which coin shows WASHINGTON?', s:singleCoin('quarter'), o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Washington is on the quarter.', d:'e'},
      {lessonId:'ku8l3', t:'Which coin is the SMALLEST?', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Dime is smallest.', d:'m'},
      {lessonId:'ku8l3', t:'Which coin is the BIGGEST silver coin?', v:null, o:[{val:'quarter'},{val:'penny',tag:'err_confused',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Quarter is biggest.', d:'m'},
      {lessonId:'ku8l3', t:'Which coin is BROWN?', v:null, o:[{val:'penny'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny is brown.', d:'m'},
      {lessonId:'ku8l3', t:'Which coin shows JEFFERSON?', v:null, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Jefferson is on the nickel.', d:'m'},
      {lessonId:'ku8l3', t:'Which coin shows ROOSEVELT?', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Roosevelt is on the dime.', d:'m'},
      ...
      {lessonId:'ku8l3', t:'A coin that is NOT silver is a…', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny is brown.', d:'m'},
      {lessonId:'ku8l3', t:'A small silver coin is most likely a…', v:null, o:[{val:'dime'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Small + silver = dime.', d:'h'},
      {lessonId:'ku8l3', t:'A big silver coin with a man\'s face is a…', v:null, o:[{val:'quarter'},{val:'dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Big + silver = quarter.', d:'h'},
      {lessonId:'ku8l3', t:'A round, brown coin is a…', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Brown = penny.', d:'h'},
      {lessonId:'ku8l3', t:'A silver coin between dime and quarter in size is a…', v:null, o:[{val:'nickel'},{val:'penny',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'}], a:0, e:'Nickel — middle size.', d:'h'},
      {lessonId:'ku8l3', t:'Lincoln on the coin = which coin?', v:null, o:[{val:'penny'},{val:'nickel',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_coin_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Penny.', d:'h'},

      // ── ku8l4 — Compare Coins (18) ──────────────────────────────────────────
      {lessonId:'ku8l4', t:'Which coin is BIGGER?', s:twoCoins('quarter','dime'), o:[{val:'quarter'},{val:'dime',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Quarter is bigger.', d:'e'},
      {lessonId:'ku8l4', t:'Which coin is SMALLER?', s:twoCoins('nickel','dime'), o:[{val:'dime'},{val:'nickel',tag:'err_more',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Dime is smaller.', d:'e'},
      {lessonId:'ku8l4', t:'Which coin is BIGGER?', s:twoCoins('quarter','penny'), o:[{val:'quarter'},{val:'penny',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Quarter is bigger.', d:'e'},
      {lessonId:'ku8l4', t:'Which coin is SMALLER?', s:twoCoins('penny','dime'), o:[{val:'dime'},{val:'penny',tag:'err_more',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Dime is smaller.', d:'e'},
      {lessonId:'ku8l4', t:'Which coin is BIGGER?', s:twoCoins('nickel','dime'), o:[{val:'nickel'},{val:'dime',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Nickel is bigger than a dime.', d:'e'},
      {lessonId:'ku8l4', t:'Which coin is BIGGER?', s:twoCoins('quarter','nickel'), o:[{val:'quarter'},{val:'nickel',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Quarter is biggest.', d:'e'},
      {lessonId:'ku8l4', t:'Find the coin that MATCHES this one.', s:singleCoin('penny'), o:[{val:'another penny'},{val:'nickel',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'dime',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_visual_confusion'}], a:0, e:'Another penny matches.', d:'e'},
      {lessonId:'ku8l4', t:'Find the coin that MATCHES this one.', s:singleCoin('dime'), o:[{val:'another dime'},{val:'penny',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'nickel',tag:'err_confused',patternTag:'err_visual_confusion'}], a:0, e:'Another dime matches.', d:'e'},
      {lessonId:'ku8l4', t:'Order from SMALLEST to BIGGEST: dime, quarter, nickel. Smallest is…', v:null, o:[{val:'dime'},{val:'nickel',tag:'err_more',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_more',patternTag:'err_size_confusion'},{val:'all same',tag:'err_same'}], a:0, e:'Dime is smallest.', d:'m'},
      {lessonId:'ku8l4', t:'Order: smallest to biggest. Biggest is…', v:null, o:[{val:'quarter'},{val:'dime',tag:'err_less',patternTag:'err_size_confusion'},{val:'nickel',tag:'err_less',patternTag:'err_size_confusion'},{val:'all same',tag:'err_same'}], a:0, e:'Quarter is biggest.', d:'m'},
      {lessonId:'ku8l4', t:'A penny and a dime — which is BIGGER?', s:twoCoins('penny','dime'), o:[{val:'penny'},{val:'dime',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Penny is bigger.', d:'m'},
      {lessonId:'ku8l4', t:'A nickel and a quarter — which is BIGGER?', s:twoCoins('nickel','quarter'), o:[{val:'quarter'},{val:'nickel',tag:'err_less',patternTag:'err_size_confusion'},{val:'same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'Quarter is biggest.', d:'m'},
      {lessonId:'ku8l4', t:'Two pennies side by side are…', v:null, o:[{val:'the same size and color'},{val:'different colors',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'different sizes',tag:'err_confused',patternTag:'err_size_confusion'},{val:'always silver',tag:'err_confused',patternTag:'err_coin_confusion'}], a:0, e:'Same coin = same.', d:'m'},
      {lessonId:'ku8l4', t:'In order from SMALLEST to BIGGEST, which is RIGHT?', v:null, o:[{val:'dime, penny, nickel, quarter'},{val:'penny, dime, nickel, quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter, nickel, penny, dime',tag:'err_confused',patternTag:'err_size_confusion'},{val:'all the same size',tag:'err_same'}], a:0, e:'Dime, penny, nickel, quarter.', d:'h'},
      {lessonId:'ku8l4', t:'A coin is silver AND smaller than a penny. It is a…', v:null, o:[{val:'dime'},{val:'nickel',tag:'err_confused',patternTag:'err_size_confusion'},{val:'quarter',tag:'err_confused',patternTag:'err_size_confusion'},{val:'penny',tag:'err_same',patternTag:'err_coin_confusion'}], a:0, e:'Dime.', d:'h'},
      {lessonId:'ku8l4', t:'Find the ODD coin out: penny, penny, dime.', v:null, o:[{val:'dime (silver and small)'},{val:'first penny',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'second penny',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'all the same',tag:'err_same'}], a:0, e:'Dime is the odd one.', d:'h'},
      {lessonId:'ku8l4', t:'Find the ODD coin out: nickel, nickel, penny.', v:null, o:[{val:'penny (brown)'},{val:'first nickel',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'second nickel',tag:'err_confused',patternTag:'err_visual_confusion'},{val:'all the same',tag:'err_same'}], a:0, e:'Penny is brown.', d:'h'},
      {lessonId:'ku8l4', t:'Is "bigger always = worth more"?', v:null, o:[{val:'NO — a dime is small but worth more than a penny'},{val:'YES — bigger always means more',tag:'err_more',patternTag:'err_size_confusion'},{val:'always the same',tag:'err_same'},{val:'cannot tell',tag:'err_confused'}], a:0, e:'NO — size and value differ.', d:'h'}
    ]
  });
})();
