...
var _l53C7 = [
  ...
  {t:'A class makes a tiny square from cardboard and a giant square on the floor. A student says: "They cannot be in the same shape group." Is the student right?', s:_svgSquare(), o:[{val:'No'},{val:'Yes',tag:_53CS}], a:0, e:'Size is non-defining. Both have 4 equal sides — both are squares.', d:'h', h:'Does size change what makes a square a square?', sk:'sort_shape_attributes', i:_i53CS()}
];
