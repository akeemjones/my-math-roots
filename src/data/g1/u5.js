...
var _l55C3 = [
  ...
  {t:'Which circle shows 2 equal parts?', s:_svgRow2(_svgHalfCircleV(),_svgUneqHalfCircle()), o:[{val:'Picture A'},{val:'Picture B',tag:_55UP},{val:'Both pictures show equal parts',tag:_55NE},{val:'Neither picture shows equal parts',tag:_55EQ}], a:0, e:'Picture A: the line goes through the center — both parts are equal. Picture B: the line is off-center, so one part is bigger.', d:'e', h:'Look at where the line is in each circle.', sk:'equal_parts_halves_fourths', i:_i55UP('In Picture A the line goes through the center, making 2 equal parts. Those are halves.')},
  {t:'Which square shows halves?', s:_svgRow2(_svgUneqHalfSquare(),_svgHalfSquareV()), o:[{val:'Picture A',tag:_55UP},{val:'Picture B'},{val:'Both pictures show halves',tag:_55NE},{val:'Neither picture shows halves',tag:_55EQ}], a:1, e:'Picture B: the line is in the middle — both parts are equal. Picture A: the line is off to one side.', d:'e', h:'Is the line in the middle or off to the side?', sk:'equal_parts_halves_fourths', i:_i55UP('The line must be in the middle for halves. Picture B has the line in the middle.')},
  {t:'Which rectangle shows 2 equal parts?', s:_svgRow2(_svgHalfRectV(),_svgUneqHalfRect()), o:[{val:'Picture A'},{val:'Picture B',tag:_55UP},{val:'Both pictures show equal parts',tag:_55NE},{val:'Neither picture shows equal parts',tag:_55EQ}], a:0, e:'Picture A: the line is in the center making 2 equal parts. Picture B: the line is near one end.', d:'e', h:'Which rectangle has its line exactly in the middle?', sk:'equal_parts_halves_fourths', i:_i55UP('Picture A has the line in the center. Both parts are the same size — those are halves.')},
  {t:'Which circle shows halves?', s:_svgRow2(_svgUneqHalfCircle(),_svgHalfCircleH()), o:[{val:'Picture A',tag:_55UP},{val:'Picture B'},{val:'Both pictures show halves',tag:_55NE},{val:'Neither picture shows halves',tag:_55EQ}], a:1, e:'Picture B: a horizontal diameter makes 2 equal parts. Picture A: the line is off-center.', d:'e', h:'Look at where the line crosses the center.', sk:'equal_parts_halves_fourths', i:_i55UP('Picture B has the line through the center — 2 equal parts. That is halves.')},
  ...
  {t:'One of these pictures does NOT show halves. Which one?', s:_svgRow2(_svgUneqHalfSquare(),_svgHalfSquareV()), o:[{val:'Picture A'},{val:'Picture B',tag:_55EQ},{val:'Both pictures show halves',tag:_55NE},{val:'Neither picture shows halves',tag:_55UP}], a:0, e:'Picture A: the line is off-center — one part is bigger. Picture B: the line is in the middle — equal parts.', d:'m', h:'Which picture has a line that is NOT in the middle?', sk:'equal_parts_halves_fourths', i:_i55UP('Picture A has an off-center line — the parts are not equal. That is NOT halves.')},
  {t:'Both rectangles are split in different ways. Which shows halves?', s:_svgRow2(_svgHalfRectH(),_svgHalfRectV()), o:[{val:'Picture A only',tag:_55EQ},{val:'Picture B only',tag:_55EQ},{val:'Both pictures show halves'},{val:'Neither picture shows halves',tag:_55EQ}], a:2, e:'Both rectangles have their midlines (horizontal or vertical), making 2 equal parts — both show halves.', d:'m', h:'Check both: is the dividing line in the middle of each?', sk:'equal_parts_halves_fourths', i:_i55SP('Both have a line through the middle. Both show 2 equal parts = halves. Direction does not matter.')},
  {t:'Look at both pictures. Which one shows halves?', s:_svgRow2(_svgUneqHalfCircle(),_svgUneqHalfSquare()), o:[{val:'Picture A',tag:_55UP},{val:'Picture B',tag:_55UP},{val:'Both pictures show halves',tag:_55NE},{val:'Neither picture shows halves'}], a:3, e:'Neither picture shows halves — both have off-center lines, so one part is bigger in each.', d:'m', h:'Look at the line in each shape. Is it in the middle?', sk:'equal_parts_halves_fourths', i:_i55NE('Both pictures have off-center lines — the parts are NOT equal. Neither shows halves.')},
  {t:'Which picture shows 4 equal parts?', s:_svgRow2(_svgFourthSquare(),_svgHalfSquareH()), o:[{val:'Picture A'},{val:'Picture B',tag:_55HF},{val:'Both pictures show 4 equal parts',tag:_55NE},{val:'Neither picture shows 4 equal parts',tag:_55EQ}], a:0, e:'Picture A has 4 equal parts (fourths). Picture B has only 2 equal parts (halves), not 4.', d:'m', h:'Count the equal parts in each picture.', sk:'equal_parts_halves_fourths', i:_i55PC('Count Picture A: 1, 2, 3, 4 equal parts. Count Picture B: 1, 2 equal parts. Only A has 4.')},
  {t:'Both circles show parts. Which circles show fourths?', s:_svgRow2(_svgFourthCircle(),_svgFourthCircle()), o:[{val:'Picture A only',tag:_55EQ},{val:'Picture B only',tag:_55EQ},{val:'Both pictures show fourths'},{val:'Neither picture shows fourths',tag:_55EQ}], a:2, e:'Both circles have 2 perpendicular diameters making 4 equal parts — both show fourths.', d:'m', h:'Count the parts in each circle. Are they equal?', sk:'equal_parts_halves_fourths', i:_i55SP('Both circles have 4 equal parts — both show fourths. They look the same here.')},
  {t:'Which picture shows fourths but NOT halves?', s:_svgRow2(_svgUneqFourthSquare(),_svgFourthCircle()), o:[{val:'Picture A',tag:_55UP},{val:'Picture B'},{val:'Both pictures show fourths',tag:_55NE},{val:'Neither picture shows fourths',tag:_55EQ}], a:1, e:'Picture B has 4 equal parts = fourths. Picture A has 4 parts but they are not equal — not fourths.', d:'m', h:'Are the parts in Picture A all the same size?', sk:'equal_parts_halves_fourths', i:_i55UP('Picture A has unequal parts — NOT fourths. Picture B has 4 equal parts — those are fourths.')},
  {t:'Which picture shows 2 equal parts?', s:_svgRow2(_svgHalfRectV(),_svgFourthRectV()), o:[{val:'Picture A'},{val:'Picture B',tag:_55HF},{val:'Both pictures show 2 equal parts',tag:_55NE},{val:'Neither picture shows 2 equal parts',tag:_55EQ}], a:0, e:'Picture A has 2 equal parts (halves). Picture B has 4 equal parts (fourths) — not 2.', d:'m', h:'Count the parts in each rectangle.', sk:'equal_parts_halves_fourths', i:_i55PC('Count Picture A: 1, 2 parts. Count Picture B: 1, 2, 3, 4 parts. Only A shows 2 equal parts.')},
  // Hard 19-22
  ...
  {t:'Which picture shows halves? (Be careful — one circle has more lines.)', s:_svgRow2(_svgHalfCircleV(),_svgFourthCircle()), o:[{val:'Picture A'},{val:'Picture B',tag:_55HF},{val:'Both pictures show halves',tag:_55NE},{val:'Neither picture shows halves',tag:_55EQ}], a:0, e:'Picture A has 1 line making 2 equal parts = halves. Picture B has 2 lines making 4 equal parts = fourths.', d:'h', h:'Count the dividing lines in each circle.', sk:'equal_parts_halves_fourths', i:_i55HF('Count: Picture A has 1 line → 2 equal parts → halves. Picture B has 2 lines → 4 equal parts → fourths.')}
];
