...
const _l4Spec = {
  ...
  _l4Q(151, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'easy',
    visual:{type:'numberLine',mode:'assessment',mark:0,ticks:[0,2,4],labels:{'0':'0'},jumps:[{from:0,to:2,label:'+2',hideToLabel:true}]},
  ...
  _l4Q(152, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'easy',
    visual:{type:'numberLine',mode:'assessment',mark:2,ticks:[2,4,6],labels:{'2':'2'},jumps:[{from:2,to:4,label:'+2',hideToLabel:true}]},
  ...
  _l4Q(153, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'easy',
    visual:{type:'numberLine',mode:'assessment',mark:0,ticks:[0,5,10],labels:{'0':'0'},jumps:[{from:0,to:5,label:'+5',hideToLabel:true}]},
  ...
  _l4Q(154, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'easy',
    visual:{type:'numberLine',mode:'assessment',mark:5,ticks:[5,10,15],labels:{'5':'5'},jumps:[{from:5,to:10,label:'+5',hideToLabel:true}]},
  ...
  _l4Q(155, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'easy',
    visual:{type:'numberLine',mode:'assessment',mark:0,ticks:[0,10,20],labels:{'0':'0'},jumps:[{from:0,to:10,label:'+10',hideToLabel:true}]},
  ...
  _l4Q(156, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'easy',
    visual:{type:'numberLine',mode:'assessment',mark:10,ticks:[10,20,30],labels:{'10':'10'},jumps:[{from:10,to:20,label:'+10',hideToLabel:true}]},
  ...
  _l4Q(157, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'easy',
    visual:{type:'numberLine',mode:'assessment',mark:4,ticks:[4,6,8],labels:{'4':'4'},jumps:[{from:4,to:6,label:'+2',hideToLabel:true}]},
  ...
  _l4Q(158, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:6,ticks:[6,8,10,12],labels:{'6':'6'},jumps:[{from:6,to:8,label:'+2',hideToLabel:true},{from:8,to:10,label:'+2',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +2. Where does the second jump land?', answer:'10', hint:'Start at 6 and take two jumps of +2 each.',
  ...
  _l4Q(159, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:10,ticks:[10,15,20,25],labels:{'10':'10'},jumps:[{from:10,to:15,label:'+5',hideToLabel:true},{from:15,to:20,label:'+5',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +5. Where does the second jump land?', answer:'20', hint:'Start at 10 and take two jumps of +5 each.',
  ...
  _l4Q(160, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:20,ticks:[20,30,40,50],labels:{'20':'20'},jumps:[{from:20,to:30,label:'+10',hideToLabel:true},{from:30,to:40,label:'+10',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +10. Where does the second jump land?', answer:'40', hint:'Start at 20 and take two jumps of +10 each.',
  ...
  _l4Q(161, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:8,ticks:[8,10,12],labels:{'8':'8'},jumps:[{from:8,to:10,label:'+2',hideToLabel:true}]},
  ...
  _l4Q(162, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:15,ticks:[15,20,25],labels:{'15':'15'},jumps:[{from:15,to:20,label:'+5',hideToLabel:true}]},
  ...
  _l4Q(163, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:30,ticks:[30,40,50],labels:{'30':'30'},jumps:[{from:30,to:40,label:'+10',hideToLabel:true}]},
  ...
  _l4Q(164, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:14,ticks:[14,16,18,20],labels:{'14':'14'},jumps:[{from:14,to:16,label:'+2',hideToLabel:true},{from:16,to:18,label:'+2',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +2. Where does the second jump land?', answer:'18', hint:'Start at 14 and take two jumps of +2 each.',
  ...
  _l4Q(165, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'medium',
    visual:{type:'numberLine',mode:'assessment',mark:25,ticks:[25,30,35,40],labels:{'25':'25'},jumps:[{from:25,to:30,label:'+5',hideToLabel:true},{from:30,to:35,label:'+5',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +5. Where does the second jump land?', answer:'35', hint:'Start at 25 and take two jumps of +5 each.',
  ...
  _l4Q(166, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'hard',
    visual:{type:'numberLine',mode:'assessment',mark:36,ticks:[36,38,40,42],labels:{'36':'36'},jumps:[{from:36,to:38,label:'+2',hideToLabel:true},{from:38,to:40,label:'+2',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +2. Where does the second jump land?', answer:'40', hint:'Start at 36 and take two jumps of +2 each.',
  ...
  _l4Q(167, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'hard',
    visual:{type:'numberLine',mode:'assessment',mark:45,ticks:[45,50,55,60],labels:{'45':'45'},jumps:[{from:45,to:50,label:'+5',hideToLabel:true},{from:50,to:55,label:'+5',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +5. Where does the second jump land?', answer:'55', hint:'Start at 45 and take two jumps of +5 each.',
  ...
  _l4Q(168, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'hard',
    visual:{type:'numberLine',mode:'assessment',mark:70,ticks:[70,80,90,100],labels:{'70':'70'},jumps:[{from:70,to:80,label:'+10',hideToLabel:true},{from:80,to:90,label:'+10',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +10. Where does the second jump land?', answer:'90', hint:'Start at 70 and take two jumps of +10 each.',
  ...
  _l4Q(169, {subSkill:'number_line_skip_count',promptTemplate:'number_line_equal_jumps',keyIdea:_l4KI6,difficulty:'hard',
    visual:{type:'numberLine',mode:'assessment',mark:88,ticks:[88,90,92,94],labels:{'88':'88'},jumps:[{from:88,to:90,label:'+2',hideToLabel:true},{from:90,to:92,label:'+2',hideToLabel:true}]},
    prompt:'The number line shows two equal jumps of +2. Where does the second jump land?', answer:'92', hint:'Start at 88 and take two jumps of +2 each.',
