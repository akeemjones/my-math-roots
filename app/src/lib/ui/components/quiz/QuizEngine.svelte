<script lang="ts">
  ...
  import { getGeminiHint } from '$lib/core/services/hint';
  import { finaliseQuiz, saveAbandonedScore } from '$lib/core/services/quiz';
  import { playCorrect, playWrong, playPassQuiz } from '$lib/ui/services/sound';
  ...
  import type { QuizState, QuizAnswer, ScoreEntry } from '$lib/core/types';
