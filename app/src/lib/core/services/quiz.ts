...
import type { Question, QuizType, QuizState, QuizAnswer, ScoreEntry } from '$lib/core/types';
import { mastery, streak, done, scores, cur, activeStudent, appTime, actDates } from '$lib/core/stores';
import { supabase } from '$lib/core/supabase';
import { pushStudentData } from '$lib/core/services/sync';
