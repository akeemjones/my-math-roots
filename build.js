...
async function build(){
  ...
  const SRC_FILES = [
    'data/shared.js','data/shared_k.js','data/shared_g1.js','data/shared_g3.js','data/g3/cbe.js','util.js','quiz-helpers.js','analytics.js','state.js','auth.js','nav.js','home.js','unit.js',
